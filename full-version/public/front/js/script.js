...
function updateAuthUI() {
  // Authentication UI should be handled by Laravel Blade directly.
  // We can leave this empty or remove it entirely, as Blade will render the correct state.
}
...
document.addEventListener('DOMContentLoaded', () => {
  // Language toggle and Auth UI are now handled by Laravel.
});
