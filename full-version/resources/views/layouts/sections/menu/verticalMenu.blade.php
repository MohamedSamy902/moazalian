...
<aside id="layout-menu" class="layout-menu menu-vertical menu" @foreach ($configData['menuAttributes'] as $attribute=>
  ...
  <div class="app-brand demo">
    <a href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::localizeUrl('/') }}" class="app-brand-link">
  ...
  <ul class="menu-inner py-1">
    ...
    @php
      if (isset($menu->permission)) {
         ...
         if ($user && !$user->hasRole('Super Admin') && !$user->can($menu->permission)) {
             continue;
         }
      }
    @endphp
    ...
    <li class="menu-item {{ $activeClass }}">
      <a href="{{ isset($menu->url) ? \Mcamara\LaravelLocalization\Facades\LaravelLocalization::localizeUrl($menu->url) : 'javascript:void(0);' }}"
